            ...
            <div class="d-flex mb-5  flex-column">
                ...
                <div class="d-flex gap-4 flex-column flex-md-row">
                    <div class="w-100 w-md-50">
                        <p class="blog-description">
                            Gulmarg, nestled in the Pir Panjal range of Jammu and Kashmir, transforms into a mesmerizing
                            winter wonderland as the snow blankets its landscapes. Known as India's premier ski
                    ...
                    <div class="w-100 w-md-50">
                        <img src="/assets/img/gulamrg.jpg" alt="Blog Image" class="img-fluid rounded-3 object-fit-cover"
                ...
                <div class="d-flex mb-5  flex-column ">
                    ...
                    <div class="w-100">
                        ...
                        <h3 class="blog-title fw-500-important">The Markhor in Kashmir: Ecology, Conservation, and
                    ...
                    <div class="d-flex gap-4 flex-column flex-md-row">
                        ...
                        <div class="w-100 w-md-50">
                            <img src="/assets/img/markhor.webp" alt="Blog Image"
                                class="img-fluid rounded-3 object-fit-cover" style="aspect-ratio: 16/9;">
                        </div>
                    </div>
                </div>
                <div class="d-flex mb-5  flex-column ">
                    ...
                    <div class="w-100">
                        <div class="d-flex flex-wrap gap-1 mb-2">
                            <div class="blog-category">Product Updates</div>
                            <div class="blog-meta">FEB 26, 2025</div>
                        </div>
                        <h3 class="blog-title fw-500-important">Exploring the Beauty of a Tulip Garden: Nature’s Vibrant Symphony</h3>

                    </div>
                    <div class="d-flex gap-4 flex-column flex-md-row">
                        <div class="w-100 w-md-50">
                            <p class="blog-description">
                            Tulips, with their brilliant colors and elegant petals, are among the most cherished flowers in the world. They symbolize renewal and beauty, making them a perfect addition to gardens that celebrate the vibrancy of spring. Nowhere is this truer than in Kashmir, home to the breathtaking Indira Gandhi Memorial....
                            </p>
                            <a href="tulip-garden.php" class="read-more">Read more &rsaquo;</a>
                        </div>


                        <div class="w-100 w-md-50">
                            <img src="/assets/img/tulip-garden.webp" alt="Blog Image"
                                class="img-fluid rounded-3 object-fit-cover" style="aspect-ratio: 16/9;">
                        </div>
                    </div>
                </div>
