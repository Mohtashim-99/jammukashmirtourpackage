                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="row g-2 pt-2">
                            ...
                            <div class="col-4"><img class="img-fluid bg-light p-1" src="/assets/img/package-2.jpg"
                                    alt="website template image"></div>
                            <div class="col-4"><img class="img-fluid bg-light p-1" src="/assets/img/package-3.jpg"
                                    alt="website template image"></div>
                            <div class="col-4"><img class="img-fluid bg-light p-1" src="/assets/img/package-2.jpg"
                                    alt="website template image"></div>
                            <div class="col-4"><img class="img-fluid bg-light p-1" src="/assets/img/package-3.jpg"
